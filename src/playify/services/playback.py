...
async def play_audio(guild_id, seek_time=0, is_a_loop=False, song_that_just_ended=None):
    ...
    # ── Background-Download: deaktiviert (YouTube blockt Server-IPs) ──
    # Download-System wurde entfernt — Bot nutzt Streaming wie gehabt.
    ...
    try:
        ...
        # ── Download-Check: deaktiviert (YouTube blockt Server-IPs) ──
        # Früher wurde hier geprüft ob eine .opus Datei im Cache liegt.
        # Das Download-System wurde entfernt — Bot nutzt Streaming.
        ...
        if not is_downloaded_file and music_player.current_info.get("source_type") != "file":
